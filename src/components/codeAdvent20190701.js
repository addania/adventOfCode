...
export const CodeAdvent20190701 = () => {
  ...
  function handleClick() {
   ...
   for (let am1=0;am1<5;am1++){
    ...
    let optInput11=am1;
    let optInput12=0;
    let finalCode1= calc2(amplifierControllerSoftware, optInput11, optInput12);
    //console.log("finalCode1",finalCode1);
    
    let optInput21=am2;
    let optInput22=finalCode1;
    let finalCode2= calc2(amplifierControllerSoftware, optInput21, optInput22);
    //console.log("finalCode2",finalCode2);

    let optInput31=am3;
    let optInput32=finalCode2;
    let finalCode3= calc2(amplifierControllerSoftware, optInput31, optInput32);
    //console.log("finalCode3",finalCode3);

    let optInput41=am4;
    let optInput42=finalCode3;
    let finalCode4= calc2(amplifierControllerSoftware, optInput41, optInput42);
    //console.log("finalCode3",finalCode4);

    let optInput51=am5;
    let optInput52=finalCode4;
    let finalCode5= calc2(amplifierControllerSoftware, optInput51, optInput52);
    //console.log("finalCode3",finalCode5);
